...
(function execute() {
	...
	*/
	...
	if (recordDataMap.get("cstPriorityClassTX") == "P1" && triWorkTask.get("cstResolutionTypeCL") != "Technician On Site") {
		var errMsg = java.lang.String.format("The Work Order with ID[%s] cannot be Completed because Resolution Status is not Technician On Site", workOrderId);
